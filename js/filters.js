...
function readFilterState() {
  ...
  const deliveryStatus = document.getElementById("f_deliveryStatus").value;
...
function filterBills(bills, f) {
  return bills.filter(b =>
    ...
    (!f.deliveryStatus || b.deliveryStatus === f.deliveryStatus) &&
...
function filterOrderLines(lines, f) {
  return lines.filter(l =>
    ...
    (!f.deliveryStatus || l.deliveryStatus === f.deliveryStatus) &&
